...
#   - playbook: a playbook in the playbook directory (default = "playbook.yml")
#   - cleanup: whether to remove the Docker container (default = true)
#   - container_id: the --name to set for the container (default = timestamp)
#   - test_idempotence: whether to test a playbook idempotence (default = true)
#   - base_url: the base url for downloading Docker files (default = https://raw.githubusercontent.com/ontic/ansible-playbook-test/master/docker)
...
base_url=${base_url:-"https://raw.githubusercontent.com/ontic/ansible-playbook-test/master/docker"}
